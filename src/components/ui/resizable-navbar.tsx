  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-[#030303]/85 border border-white/[0.07]",
        className,
      )}
    >
      {children}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-[#030303]/90 border border-white/[0.07]",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-xl bg-[#030303]/95 backdrop-blur-xl border border-white/[0.07] px-4 py-8 shadow-[0_8px_40px_rgba(0,0,0,0.6)]",
            className,
          )}
        >
          {children}
