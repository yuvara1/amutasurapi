          ...
          <FadeUp>
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <motion.div whileHover={{ scale: 1.04, boxShadow: "0 8px 30px rgba(34,197,94,0.3)" }} whileTap={{ scale: 0.97 }}>
                <Button onClick={() => navigate("register")} className="bg-emerald-500 hover:bg-emerald-400 text-white font-semibold px-6 py-2.5 h-auto gap-2">
                  <Handshake size={15} /> Join FoodBridge
                </Button>
              </motion.div>
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Button variant="outline" onClick={() => navigate("landing")} className="border-white/15 text-white/60 hover:text-white hover:border-white/30 px-6 py-2.5 h-auto">
                  Back to home
                </Button>
              </motion.div>
            </div>
