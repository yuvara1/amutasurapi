...
const DonorDashboard = lazy(
  () => import("@/features/dashboard/DonorDashboard"),
);
const NGODashboard = lazy(() => import("@/features/dashboard/NGODashboard"));
const VolunteerDashboard = lazy(
  () => import("@/features/dashboard/VolunteerDashboard"),
);
const AdminDashboard = lazy(
  () => import("@/features/dashboard/AdminDashboard"),
);
const DonorDonations = lazy(
  () => import("@/features/donations/DonorDonations"),
);
const CreateDonation = lazy(
  () => import("@/features/donations/CreateDonation"),
);
const DonorImpact = lazy(() => import("@/features/impact/DonorImpact"));
const NGORequirements = lazy(
  () => import("@/features/requirements/NGORequirements"),
);
...
const AdminDonations = () => (
  <Wrap>
    <AdminMonitoringD view="donations" />
  </Wrap>
);
const AdminDeliveries = () => (
  <Wrap>
    <AdminMonitoringD view="deliveries" />
  </Wrap>
);
